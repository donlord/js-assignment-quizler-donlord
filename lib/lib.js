...
const objMaker = exports.objMaker = (name, message, choices) => {
  return {
    type: 'list',
    name: name,
    message: message,
...
const createQuestions = exports.createQuestions = inputObject => {
  if (inputObject === {} || typeof inputObject === 'undefined' || Object.keys(inputObject).length === 0) {
    return [];
  }
...
const writeFile = exports.writeFile = (filename, data) => {
  return new Promise((resolve, reject) => {
